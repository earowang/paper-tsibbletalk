...
with HTML elements and Javascript for interactivity, although they do
not emphasise on interactive graphics. The \CRANpkg{htmlwidgets} package
opens a door to embedding Javascript libraries into R such that users
are able to write only R code to generate web-based plots. Many
