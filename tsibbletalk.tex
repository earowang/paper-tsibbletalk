...
Figure \ref{fig:highlight-retail-1}, it puts the emphasis on the trend.
When the data are wrapped over origin-less time units, such as one or
two quarters, it makes seasonal patterns more pronounced. The
\CRANpkg{tsibbletalk} package provides a shiny module
...
Standard seasonal plots break the overall time into two components:
