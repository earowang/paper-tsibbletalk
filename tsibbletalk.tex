...
\hypertarget{related-works-interactive-visualisation-systems-with-linking-views}{%
\section{Related works: interactive visualisation systems with linking
views}\label{related-works-interactive-visualisation-systems-with-linking-views}}
...
\hypertarget{motivation-tidy-temporal-data-and-workflow}{%
\section{Motivation: tidy temporal data and
workflow}\label{motivation-tidy-temporal-data-and-workflow}}
...
function from \CRANpkg{feasts}, which summarises original data by each
...
\hypertarget{shared-temporal-data-for-coordinated-views-with-examples}{%
\section{Shared temporal data for coordinated views with
examples}\label{shared-temporal-data-for-coordinated-views-with-examples}}
...
\hypertarget{slicing-and-dicing-time-with-examples}{%
\section{Slicing and dicing time with
examples}\label{slicing-and-dicing-time-with-examples}}
