...
engine. The \texttt{period} argument is to specify the minimum number of
seasonal blocks, for example data shifted by ``1 day'', ``2 days'', or
``1 week'', etc. The following code chunk generates Figure
\ref{fig:wrap-ped}.
