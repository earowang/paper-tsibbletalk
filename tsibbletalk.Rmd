...
# Related works: interactive visualisation systems with linking views
...
# Motivation: tidy temporal data and workflow
...
# Shared temporal data for coordinated views with examples
...
# Slicing and dicing time with examples
